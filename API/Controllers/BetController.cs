...
namespace API.Controllers {
    ...
    public class BetController :ControllerBase {
        ...
        public async Task<ActionResult<List<Bet>>> GetUserBets(int userId) {
            List<Bet> allUsersBets = new List<Bet>();
            ...
            foreach(var bet in bets) {
                ...
                if(bet.UserId == userId) {
                    ...
                    if(actualContest.EndDate > DateTime.Now && actualMatch.Date > DateTime.Now && actualMatch.IsAvailable == 1 && actualMatch.GuestGoals == -1 && actualMatch.HomeGoals == -1) {
                        bet.Match = null;
                        bet.Contest = null;
                        bet.User = null;
                        allUsersBets.Add(bet);
                    }
                }

            }

            return Ok(allUsersBets);
        }
